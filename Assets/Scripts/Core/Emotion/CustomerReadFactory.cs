...
namespace LastCall.Core
{
    ...
    public static class CustomerReadFactory
    {
        ...
        // The VIP read-rule layer (Open Book / Poker Face / The Liar) retired with the
        // card loop's VIPs (PLAN_tycoon_pivot P7). Reads are built plainly now; special
        // guests with read rules return later against the tycoon loop (GDD 23 §0).
