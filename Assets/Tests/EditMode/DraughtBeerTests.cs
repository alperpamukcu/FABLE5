...
namespace LastCall.Tests
{
    ...
    public sealed class DraughtBeerTests
    {
        ...
        public void ACocktailIsNeverGradedOnAHeadItCannotHave()
        {
            ...
            // Recomposed satisfaction (P11, + the 2026-08-20 accuracy term: exact 0.75 +
            // 0.10×(accuracy−0.5) + craft 0.20 + fill 0.12; unmeasured accuracy reads 1).
            // What this test is really pinning is that the HEAD term is absent for a
            // cocktail: a full glass of spirit scores everything else in full and no head.
            Assert.AreEqual(0.75 + 0.10 * 0.5 + 0.20 * 0.5 + 0.12 * 0.5, verdict.Satisfaction, 1e-9,
