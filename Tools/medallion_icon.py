...
# GOLD (2026-09-06, the author: "konforun iconu değiştirilsin altın madalyon olsun"): the disc
# in UITheme.Amber — the star's own metal — over a deeper Malt rim so the two still separate.
# (It was Cyan, the room's colour, from 2026-09-05 to 2026-09-06.)
LIT = [(0xF5, 0xC9, 0x7B), (0xE8, 0xA3, 0x3D), (0xC9, 0x82, 0x2B), (0x8F, 0x5A, 0x1E)]
# UITheme.Malt for the rim — the darker gold.
RIM = [(0xC9, 0x8F, 0x2B), (0x9E, 0x6A, 0x1D), (0x6B, 0x44, 0x16), (0x3A, 0x24, 0x10)]
